...
//    private var player1: HumanPlayer = HumanPlayer(id: "")
//    private var player2: ComputerPlayer = ComputerPlayer(id: "", num: PlayerNum.two)
//    private var player3: ComputerPlayer = ComputerPlayer(id: "", num: PlayerNum.three)
...
//        }
    ...
    func setLandlordAndStartGame(landlordNum: PlayerNum) {
        var _: Player, currentPlayerNum: Int
        switch landlordNum {
        case .one:
//            landlord = player1
            currentPlayerNum = 0
